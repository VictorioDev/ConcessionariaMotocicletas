...
<form:form action="/ConcessionariaDeMotocicletas/proprietarios/editar" method="POST" modelAttribute="proprietario" acceptCharset="UTF-8">
    ...
    <div class="form-group row">
        <div class="col-2">
            <form:label path="dataNascimento" cssClass="scol-sm-2 col-form-label bold">Data de Nascimento:</form:label>
        </div>
    ...
    <div class="form-group row">
        <div class="col-2">
            <form:label path="email" cssClass="scol-sm-2 col-form-label bold">E-mail:</form:label>
        </div>
