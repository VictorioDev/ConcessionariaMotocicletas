...
<h3 class="title">
    <span class="oi" data-glyph="folder" title="Marcas" aria-hidden="true"></span> Editar Marca
</h3>

<form:form action="/ConcessionariaDeMotocicletas/marcas/editar" method="POST" modelAttribute="marca" acceptCharset="UTF-8">
    ...
    <div class="form-group row">
            <div class="col-10">
            <form:input type="hidden" path="idMarca" cssClass="form-control"/>
        </div>
    </div>
